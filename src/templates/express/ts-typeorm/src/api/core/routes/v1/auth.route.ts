...
export class AuthRouter extends Router {
    ...
    define(): void {
         ...
         * @apiUse UnprocessableEntity
         */
        this.router.route('/logout').post(Guard.authorize([ROLE.admin, ROLE.user]), AuthController.logout);
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/confirm').patch(Validator.check(confirm), AuthController.confirm);
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/request-password').get(Validator.check(requestPassword), AuthController.requestPassword);
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/refresh-token').post(Validator.check(refresh), AuthController.refresh);
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/facebook').get(Guard.oAuth('facebook'));
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/facebook/callback').get(Validator.check(oauthCb), Guard.oAuthCallback('facebook'), AuthController.oAuth);
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/google').get(Guard.oAuth('google'), AuthController.oAuth);
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/google/callback').get(Validator.check(oauthCb), Guard.oAuthCallback('google'), AuthController.oAuth);
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/github').get(Guard.oAuth('github'), AuthController.oAuth);
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/github/callback').get(Validator.check(oauthCb), Guard.oAuthCallback('github'), AuthController.oAuth);
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/linkedin').get(Guard.oAuth('linkedin'), AuthController.oAuth);
         ...
         * @apiUse NotAcceptable
         */
        this.router.route('/linkedin/callback').get(Validator.check(oauthCb), Guard.oAuthCallback('linkedin'), AuthController.oAuth);
    }
}
