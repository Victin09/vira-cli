...
export class UserRouter extends Router {
    ...
    define(): void {
        ...
        this.router
             ...
             * @apiUse ExpectationFailed
             */
            .put(Guard.authorize([ROLE.admin, ROLE.user]), Validator.check(replaceUser), UserController.update)
             ...
             * @apiUse ExpectationFailed
             */
            .patch(Guard.authorize([ROLE.admin, ROLE.user]), Validator.check(updateUser), UserController.update)
