...
const Safe = (): any => {
    return (target: Controller, key: string): any => {
        const method = target[key] as (req: Request, res: Response, next: NextFunction) => Promise<void> | void;
        ...
        return target[key] as (req: Request, res: Response, next: NextFunction) => void;
    };
};
