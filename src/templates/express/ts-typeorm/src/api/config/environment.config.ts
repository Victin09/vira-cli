...
import { DATABASE_ENGINE, ENVIRONMENT, CONTENT_TYPE as CONTENT_TYPE_ENUM } from '@enums';
...
export class Environment {
     ...
     */
    readonly dirs: string[] = ['archives', 'documents', 'images', 'images/master-copy', 'images/rescale', 'audios', 'videos'];
    ...
    validates(): Environment {
        this.keys.forEach((key: string) => {
            this.variables[key] = this.rules[key] !== undefined ? this.rules[key](this.variables[key]) : undefined;
        });
    ...
    aggregates(): Environment {
        this.cluster = {
            ...
            TYPEORM: {
                ...
                ENTITIES: [`${process.cwd()}/${this.base}/api/core/models/**/*.model.js`, `${process.cwd()}/${this.base}/api/resources/**/*.model.js`],
                MIGRATIONS: `${process.cwd()}/${this.base}/migrations/**/*.js`,
                SUBSCRIBERS: [`${process.cwd()}/${this.base}/api/core/subscribers/**/*.subscriber.js`, `${process.cwd()}/${this.base}/api/resources/**/*.subscriber.js`],
            },
            UPLOAD: {
...
const environment = Environment.get().loads(process.versions.node).extracts(process.env).validates().aggregates().directories();
